...
public class RSAPem {
     ...
     **/
    public RSAPem(RSAPublicKey publicKey, RSAPrivateKey privateKeyOrNull) {
        this(
     ...
     */
    static public RSAPem FromPEM(String pem) throws Exception {
     ...
     */
    public RSAPem CopyToNew(boolean convertToPublic) {
        if (convertToPublic) {
            return new RSAPem(Key_Modulus, Key_Exponent, null, null, null, null, null, null);
        }
        return new RSAPem(Key_Modulus, Key_Exponent, Key_D, Val_P, Val_Q, Val_DP, Val_DQ, Val_InverseQ);
    }
     ...
     */
    public RSAPem SwapKey_Exponent_D__Unsafe() throws Exception {
        if (Key_D == null) throw new Exception(T("SwapKey只支持私钥", "SwapKey only supports private keys"));
        return new RSAPem(Key_Modulus, Key_D, Key_Exponent);
    }
     ...
     */
    static public RSAPem FromXML(String xml) throws Exception {
        RSAPem rtv = new RSAPem();
        ...
        if (rtv.Key_D != null) {
            if (rtv.Val_P == null || rtv.Val_Q == null || rtv.Val_DP == null || rtv.Val_DQ == null || rtv.Val_InverseQ == null) {
                return new RSAPem(rtv.Key_Modulus, rtv.Key_Exponent, rtv.Key_D);
            }
        }
